...
<template>
  ...
  >
    <picture v-if="img" class="w-4 h-4 translate-y-0.5" style="margin: 0 0.25em 0 0">
    ...
    <Icon v-else-if="icon" :name="icon" class="translate-y-1 mr-0.5" style="font-size: 1.2em" />
