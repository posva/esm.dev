...
<template>
  <div class="card" :class="{ interacting }">
    <div class="card_translater">
      ...
      >
        <section class="select-none card_back">
          <slot name="back">Back</slot>
        </section>
        <section class="select-none card_front">
...
.card {
  ...
  --translate-x: v-bind('springTranslate.x + "px"') --translate-y:
    v-bind('springTranslate.y + "px"');
}
</style>
