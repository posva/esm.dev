...
export type EasingFn = (currentTime: number, initialValue: number, changeInValue: number, duration: number) => number
...
// manages the ids used to define the DisplayObject ease variable (enabled multiple eases attached to the same object)
  id: number = _easeId++
     ...
     * @returns {Easing}
     */
    add(element: Container | Container[], params: object, options?: EaseOptions): Easing {
        options = options || {}
     ...
     * @returns {Easing}
     */
    target(element: Container, target: Container | Point, speed: number, options?: EaseOptions): Easing {
     ...
     * @returns {Easing}
     */
    face(element: Container, target: Container | Point, speed: number, options?: EaseOptions): Easing {
